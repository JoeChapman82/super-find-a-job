...
const gulpConfig = {
    paths: {
        ...
        govImages: [`${__dirname}/node_modules/govuk-frontend/govuk/assets/images/**.*{png,svg}`],
...
gulp.task('default', gulp.parallel(watch, sassTask, uglyJsTask, serverTask, browserSyncTask));
